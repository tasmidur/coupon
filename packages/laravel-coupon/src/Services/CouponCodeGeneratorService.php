...
namespace Tasmidur\LaravelCoupon\Services;
...
class CouponCodeGeneratorService
{
    ...
    public function __construct(string $characters = '123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz', string $couponFormat = '*****-*****')
    {
